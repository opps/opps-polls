...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PollBox.channel_name'
        db.add_column(u'polls_pollbox', 'channel_name',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'PollBox.channel_long_slug'
        db.add_column(u'polls_pollbox', 'channel_long_slug',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PollBox.channel_name'
        db.delete_column(u'polls_pollbox', 'channel_name')

        # Deleting field 'PollBox.channel_long_slug'
        db.delete_column(u'polls_pollbox', 'channel_long_slug')
