...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Poll', fields ['slug']
        db.delete_unique(u'polls_poll', ['slug'])

        # Adding field 'PollBoxPolls.date_available'
        db.add_column(u'polls_pollboxpolls', 'date_available',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True),
                      keep_default=False)

        # Adding field 'PollBoxPolls.date_end'
        db.add_column(u'polls_pollboxpolls', 'date_end',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding unique constraint on 'Poll', fields ['slug']
        db.create_unique(u'polls_poll', ['slug'])

        # Deleting field 'PollBoxPolls.date_available'
        db.delete_column(u'polls_pollboxpolls', 'date_available')

        # Deleting field 'PollBoxPolls.date_end'
        db.delete_column(u'polls_pollboxpolls', 'date_end')
    ...
    models = {
        ...
        u'polls.pollboxpolls': {
            'Meta': {'ordering': "('order',)", 'object_name': 'PollBoxPolls'},
            'date_available': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True'}),
            'date_end': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
